...
function InactiveContent() {
  ...
  return (
    <div className="relative max-w-md w-full bg-neutral-900/50 border border-neutral-800 rounded-3xl p-8 md:p-10 backdrop-blur-xl shadow-2xl flex flex-col items-center gap-8 text-center animate-scaleIn">
      {/* Icon Badge */}
      ...
      {/* Details box */}
      <div className="w-full bg-neutral-950/80 border border-neutral-800/80 rounded-2xl p-4 flex flex-col gap-2 text-left font-mono text-xs text-neutral-500">
        <div>
          <span className="text-neutral-400">Slug:</span> /{slug}
        </div>
        <div>
          <span className="text-neutral-400">Status:</span> Inactive
        </div>
      </div>
      ...
      <Link
        href="/"
        className="w-full bg-white hover:bg-neutral-200 text-black font-bold py-3.5 px-6 rounded-xl text-sm transition-all hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 shadow-lg select-none cursor-pointer font-sans"
      >
...
export default function InactivePage() {
  return (
    <div className="min-h-screen bg-neutral-950 text-neutral-100 flex flex-col font-sans relative overflow-hidden items-center justify-center px-4">
      ...
      <Suspense fallback={
        <div className="relative max-w-md w-full bg-neutral-900/50 border border-neutral-800 rounded-3xl p-8 backdrop-blur-xl shadow-2xl flex flex-col items-center gap-6 text-center animate-pulse">
